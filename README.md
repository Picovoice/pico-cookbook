...
- [Contact Center Agent Assist](recipes/contact-center-agent-assist): On-device contact-center transcription with domain-specific vocabulary trained over the Cheetah Model API. Live customer speech surfaces matching help-center articles in a split-screen agent view.
