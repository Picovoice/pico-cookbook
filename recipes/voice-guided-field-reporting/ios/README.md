# Voice Guided Field Reporting on iOS
...
These instructions assume your current working directory is `recipes/voice-guided-field-reporting/ios`.
...
in [ViewModel.swift](VoiceGuidedFieldReporting/ViewModel.swift).
...
1. Open the `VoiceGuidedFieldReporting` project in XCode
