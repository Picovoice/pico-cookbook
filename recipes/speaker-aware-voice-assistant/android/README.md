# Speaker-Aware Voice Assistant in Android
...
These instructions assume your current working directory is `recipes/speaker-aware-voice-assistant/android`.
...
in [MainActivity.java](speaker-aware-voice-assistant/src/main/java/ai/picovoice/speakerawarevoiceassistant/MainActivity.java).
...
1. Open the `speaker-aware-voice-assistant` project in Android Studio.
