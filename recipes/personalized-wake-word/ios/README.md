...
in [ViewModel.swift](PersonalizedWakeWord/ViewModel.swift).

```console
cd pico-cookbook/recipes/personalized-wake-word/ios
...
1. Open the `PersonalizedWakeWord` project in XCode
