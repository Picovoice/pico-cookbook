    ...
    while (!isInterrupted) {
      if (!isWakeWordDetected) {
        ...
        if (isEndpoint) {
          ...
          if (profile) {
            console.log(`[Cheetah RTF: ${cheetahProfiler.rtf()}]`);
          }
        }
      } else {
        ...
        console.log(`[Delay: ${delaySec.toFixed(3)} sec]`);
        if (flushedPcm !== null) {
