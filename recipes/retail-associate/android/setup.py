...
def main() -> None:
    ...
    shutil.copy(args.porcupine_keyword_path, os.path.join(public_folder, "retail_associate_android.ppn"))
    shutil.copy(args.rhino_context_path, os.path.join(public_folder, "retail_associate_android.rhn"))
    ...
    main_activity_path = os.path.join(
        ...
        "src",
        "main",
        "java/ai/picovoice/retailassociate",
        "MainActivity.java")
