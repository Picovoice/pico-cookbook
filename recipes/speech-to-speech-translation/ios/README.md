...
Once you have the model trained, add it to the [resources](./SpeechToSpeechTranslationDemo/resources) directory
and include it as an argument to the `Porcupine` initialization in [VieModel.swift](./SpeechToSpeechTranslationDemo/ViewModel.swift)
