...
def main() -> None:
    ...
    shutil.copy(args.porcupine_keyword_path, os.path.join(public_folder, "voice_picking_ios.ppn"))
    shutil.copy(args.rhino_context_path, os.path.join(public_folder, "voice_picking_ios.rhn"))
